...
async function generateEnglishConversations() {
...
async function generateHinglishConversations() {
  const allConversations = [];
...
async function main() {
  ...
  try {
    ...
    const englishConversations = await generateEnglishConversations();
    console.log(`Generated ${englishConversations.length} English conversations`);
    
    // Generate Hinglish conversations
    console.log('Generating Hinglish conversations...');
    const hinglishConversations = await generateHinglishConversations();
